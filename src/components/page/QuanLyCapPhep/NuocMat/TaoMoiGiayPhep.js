      ...
      <>
        <div className="exploit-surfacewater">
            <div className="pb-2 mx-0">
                <label for="organization_name" className="col-sm-12 col-form-label fw-bold font-13">Tên tổ chức/cá nhân  được CP</label>
            ...
            <div className="pb-2 mx-0">
                <label for="organization_address" className="col-sm-12 col-form-label fw-bold font-13"> Địa chỉ tổ chức/cá nhân được CP </label>
                <div className="col-sm-12">
            ...
            <div className="pb-2 mx-0">
                <label for="license_num" className="col-sm-12 col-form-label fw-bold font-13"> Số GP </label>
                <div className="col-sm-12">
                    <input type="text" className="form-control form-control-sm font-13" id="license_num" name="license_num" placeholder=" -- Số GP --" />
                </div>
            </div>
            <div className="pb-2 mx-0">
                <label for="license_name" className="col-sm-12 col-form-label fw-bold font-13"> Tên văn bản GP</label>
                <div className="col-sm-12">
                    <input type="text" className="form-control form-control-sm font-13" id="license_name" name="license_name" placeholder=" -- Tên văn bản --" />
                </div>
            </div>
            <div className="pb-2 mx-0">
                <label for="co_quan_cp" className="col-sm-12 col-form-label fw-bold font-13"> Cơ quan cấp phép </label>
                <div className="col-sm-12">
            ...
            <div className="pb-2 mx-0">
                <label for="dv_tham_dinh" className="col-sm-12 col-form-label fw-bold font-13"> Đơn vị thẩm định </label>
                <div className="col-sm-12">
            ...
            <div className="row mx-0">
                <div className="pb-2 mx-0 col-sm-6">
                    <label for="cap_tham_quyen" className="col-sm-12 col-form-label fw-bold font-13">Cấp thẩm quyền </label>
                    <div className="col-sm-12">
                ...
                <div className="pb-2 mx-0 col-sm-6">
                    <label for="license_type" className="col-sm-12 col-form-label fw-bold font-13">Loại hình GP </label>
                    <div className="col-sm-12">
                        <div className="form-group">
            ...
            <div className="row m-0">
                <div className="col-sm-4 pb-2 mx-0">
                    <label for="nguoi_ky_gp" className="col-sm-12 col-form-label fw-bold font-13"> Người ký GP </label>
                    <div className="col-sm-12">
                        <input type="text" className="form-control form-control-sm font-13" id="nguoi_ky_gp" name="nguoi_ky_gp" placeholder=" -- Người ký GP --" />
                    </div>
                </div>
                <div className="col-sm-4 pb-2 mx-0">
                    <label for="chuc_vu_nguoi_ky_gp" className="col-sm-12 col-form-label fw-bold font-13"> Chức vụ </label>
                    <div className="col-sm-12">
                ...
                <div className="col-sm-4 pb-2 mx-0">
                    <label for="ngay_ky_gp" className="col-sm-12 col-form-label fw-bold font-13">Ngày ký </label>
                    <div className="col-sm-12">
                        <input type="date" className="form-control form-control-sm font-13" id="ngay_ky_gp" name="ngay_ky_gp" placeholder=" -- Ngày ký --" />
                    </div>
                </div>
            </div>
            <div className="row m-0 px-2 g-2">
                <div className="col-sm-6 pb-2 px-0 mx-0">
                    <label for="ngay_hieu_luc_dp" className="col-sm-12 col-form-label fw-bold font-13">Ngày hiệu lực GP</label>
                    <div className="col-sm-12">
                ...
                <div className="col-sm-6 pb-2 pl-2 pr-0 mx-0">
                    <label for="han_hieu_luc_dp" className="col-sm-12 col-form-label fw-bold font-13">Hạn hiệu lực GP </label>
                    <div className="col-sm-12">
            ...
            <div className="pb-2 mx-0">
                <label for="noi_nhan_gp" className="col-sm-12 col-form-label fw-bold font-13">Nơi nhận GP </label>
                <div className="col-sm-12">
                    <input type="text" className="form-control form-control-sm font-13" id="noi_nhan_gp" name="noi_nhan_gp" placeholder=" -- Nơi nhận GP --" />
                </div>
            </div>
            <div className="pb-2 mx-0">
                <label for="ghi_chu_gp" className="col-sm-12 col-form-label fw-bold font-13">Ghi chú GP</label>
                <div className="col-sm-12">
        ...
        <div className="exploit-surfacewater mb-2">
            <p className="col-12 py-1 px-2 exploit-surfacewater-title fw-bold mb-2">Thanh tra - Kiểm tra</p>
            <div className="pb-2 mx-0">
        ...
        <div className="exploit-surfacewater mb-2">
            <p className="col-12 py-1 px-2 exploit-surfacewater-title fw-bold mb-2">Tiền cấp quyền khai thác sử dụng</p>
            <div className="pb-2 mx-0">
            <table className="table table-bordered">
                <thead className="thead-light">
                        <tr className="text-center">
            ...
            <div className="modal fade" id="TienCapQuyen" tabindex="-1" aria-labelledby="TienCapQuyenLabel" aria-hidden="true">
                <div className="modal-dialog modal-dialog-centered">
                    ...
                    <div className="modal-body">
                        <div className="form-group">
                            <label className="font-13 fw-bold" for="so_quyet_dinh">Số quyết định</label>
                            <input type="text" className="form-control font-13" id="so_quyet_dinh" placeholder="Số quyết định" />
                        </div>
                        <div className="form-group">
                            <label className="font-13 fw-bold" for="tong_tien">Tổng tiền</label>
        ...
        <div className="exploit-surfacewater mb-2">
            <p className="col-12 py-1 px-2 exploit-surfacewater-title fw-bold mb-2">Thông tin tài liệu đính kèm</p>
            <div className="pb-2 mx-0">
                <div className="d-flex justify-content-start align-items-center mb-2 px-2">
                    <label for="don_xin_cp" className="col-6 font-13">Đơn xin cấp phép</label>
    ...
    <>
        ...
        <div className="exploit-surfacewater">
            <div className="row pb-2 mx-0">
                <label for="construction_name" className="col-sm-12 col-form-label fw-bold font-13">Tên công trình</label>
                <div className="col-sm-12">
            ...
            <div className="row pb-2 mx-0">
                <label for="construction_type" className="col-sm-12 col-form-label fw-bold font-13"> Ký hiệu công trình </label>
                <div className="col-sm-12">
            ...
            <div className="row pb-2 mx-0">
                <label for="contruction_address" className="col-sm-12 col-form-label fw-bold font-13"> Địa điểm công trình</label>
                <div className="col-sm-12">
            ...
            <div className="row pb-2 mx-0">
                <div className="col-sm-6 pb-2 mx-0">
                    <label for="huyen" className="col-sm-12 col-form-label fw-bold font-13">Huyện </label>
                    <div className="col-sm-12">
                        <div className="form-group">
                ...
                <div className="col-sm-6 pb-2 mx-0">
                    <label for="xa" className="col-sm-12 col-form-label fw-bold font-13">Xã </label>
                    <div className="col-sm-12">
                        <div className="form-group">
            ...
            <div className="pb-2 px-2 mx-0">
                <label for="muc_dich_sd" className="col-sm-12 col-form-label fw-bold font-13">Mục đích sử dụng </label>
                <div className="col-sm-12">
            ...
            <div className="pb-2 px-2 mx-0">
                <label for="nguon_nuoc_kt_sd" className="col-sm-12 col-form-label fw-bold font-13">Nguồn nước khai thác sử dụng</label>
                <div className="col-sm-12">
            ...
            <div className="row pb-2 mx-0">
                <label for="thuoc_song" className="col-sm-12 col-form-label fw-bold font-13"> Thuộc sông</label>
                <div className="col-sm-12">
                    <input type="text" className="form-control form-control-sm" id="thuoc_song" name="thuoc_song" placeholder=" -- Thuộc sông --" />
                </div>
            </div>
            <div className="row pb-2 mx-0">
                <label for="thuoc_luu_vuc_song" className="col-sm-12 col-form-label fw-bold font-13"> Thuộc lưu vực sông</label>
                <div className="col-sm-12">
            ...
            <div className="row pb-2 mx-0">
                <label for="che_do_kt" className="col-sm-12 col-form-label fw-bold font-13"> Chế độ khai thác</label>
                <div className="col-sm-12">
            ...
            <div className="pb-2 mx-0 px-2">
                <label for="luong_nuoc_kt_sd" className="col-sm-12 col-form-label fw-bold font-13"> Lượng nước khai thác, sử dụng</label>
                <div className="col-sm-12">
            ...
            <div className="pb-2 mx-0 px-2">
                <label for="phuong_thuc_kt" className="col-sm-12 col-form-label fw-bold font-13"> Phương thức khai thác</label>
                <div className="col-sm-12">
            ...
            <div className="row pb-2 mx-0">
                <div className="col-sm-6 pb-2 mx-0">
                    <label for="loai_kinh_tuyen_truc" className="col-sm-12 col-form-label fw-bold font-13">Loại kinh tuyến trục </label>
                    <div className="col-sm-12">
                        <div className="form-group">
                ...
                <div className="col-sm-6 pb-2 mx-0">
                    <label for="mui_chieu" className="col-sm-12 col-form-label fw-bold font-13">Múi chiếu </label>
                    <div className="col-sm-12">
                        <div className="form-group">
            ...
            <div className="row pb-2 mx-0">
                <label for="nam_sd" className="col-sm-12 col-form-label fw-bold font-13"> Năm sử dụng</label>
                <div className="col-sm-12">
                    <input type="text" className="form-control form-control-sm" id="nam_sd" name="nam_sd" placeholder=" -- Năm sử dụng --" />
                </div>
            </div>
            <div className="pb-2 mx-0 px-2">
                <label for="ghi_chu_ct" className="col-sm-12 col-form-label fw-bold font-13"> Ghi chú CT</label>
                <div className="col-sm-12">
        ...
        <div className="exploit-surfacewater mb-2">
            <div className="row pb-2 mx-0">
                <label for="cong_suat_lap_may" className="col-sm-12 col-form-label fw-bold font-13"> Công suất lắp máy(MW)</label>
                <div className="col-sm-12">
            ...
            <div className="row pb-2 mx-0">
                <label for="q_max_thuy_dien" className="col-sm-12 col-form-label fw-bold font-13"> Lưu lượng lớn nhất qua nhà máy thủy điện (m3/s)</label>
                <div className="col-sm-12">
            ...
            <div className="row pb-2 mx-0">
                <label for="q_xa_tt" className="col-sm-12 col-form-label fw-bold font-13"> Lưu lượng xả dòng chảy tối thiểu (m3/s)</label>
                <div className="col-sm-12">
            ...
            <div className="row pb-2 mx-0">
                <label for="dung_tich_huu_ich" className="col-sm-12 col-form-label fw-bold font-13"> Dung tích hữu ích (triệu m3)</label>
                <div className="col-sm-12">
            ...
            <div className="row pb-2 mx-0">
                <label for="dung_tich_toan_bo" className="col-sm-12 col-form-label fw-bold font-13"> Dung tích toàn bộ (triệu m3)</label>
                <div className="col-sm-12">
            ...
            <div className="row pb-2 mx-0">
                <label for="muc_nuoc_chet" className="col-sm-12 col-form-label fw-bold font-13"> Mực nước chết (m)</label>
                <div className="col-sm-12">
                    <input type="text" className="form-control form-control-sm" id="muc_nuoc_chet" name="muc_nuoc_chet" placeholder=" -- Mực nước chết (m) --" />
                </div>
            </div>
            <div className="row pb-2 mx-0">
                <label for="muc_nuoc_dang_bt" className="col-sm-12 col-form-label fw-bold font-13"> Mực nước dâng bình thường (m)</label>
                <div className="col-sm-12">
            ...
            <div className="row pb-2 mx-0">
                <label for="muc_nuoc_max_truoc_lu" className="col-sm-12 col-form-label fw-bold font-13"> Mực nước cao nhất trước lũ (m)</label>
                <div className="col-sm-12">
            ...
            <div className="row pb-2 mx-0">
                <label for="muc_nuoc_don_lu" className="col-sm-12 col-form-label fw-bold font-13"> Mực nước đón lũ (m)</label>
                <div className="col-sm-12">
        ...
        <div className="exploit-surfacewater mb-2">
            <p className="col-12 py-1 px-2 exploit-surfacewater-title fw-bold mb-2">Lưu lượng theo mục đích khai thác sử dụng</p>
            <div className="pb-2 mx-0 px-2">
            <table className="table table-bordered">
                <thead className="thead-light">
                <tr className="text-center">
            ...
            <div className="modal fade" id="LuuLuongThepMucDichKTSD" tabindex="-1" aria-labelledby="LuuLuongThepMucDichKTSDLabel" aria-hidden="true">
                <div className="modal-dialog modal-dialog-centered">
                    ...
                    <div className="modal-body">
                        <div className="form-group">
                            <label className="font-13 fw-bold" for="muc_dich">Mục đích</label>
                            <input type="text" className="form-control font-13" id="muc_dich" placeholder="Mục đích" />
                        </div>
                        <div className="form-group">
                            <label className="font-13 fw-bold" for="luu_luong">Lưu lượng</label>
                            <input type="text" className="form-control font-13" id="luu_luong" placeholder="Lưu lượng" />
                        </div>
                        <div className="form-group">
                            <label className="font-13 fw-bold" for="dv_do">Đơn vị đo</label>
        ...
        <div className="exploit-surfacewater mb-2">
            <p className="col-12 py-1 px-2 exploit-surfacewater-title fw-bold mb-2">Tọa độ công trình</p>
            <div className="pb-2 mx-0 px-2">
            <table className="table table-bordered">
                <thead className="thead-light">
                        <tr className="text-center">
            ...
            <div className="modal fade" id="ToaDoCongTrinh" tabindex="-1" aria-labelledby="ToaDoCongTrinhLabel" aria-hidden="true">
                <div className="modal-dialog modal-dialog-centered">
                    ...
                    <div className="modal-body">
                        <div className="form-group">
                            <label className="font-13 fw-bold" for="ky_hieu_ct">Ký hiêu CT</label>
                            <input type="text" className="form-control font-13" id="ky_hieu_ct" placeholder="Ký hiêu CT" />
                        </div>
                        <div className="form-group">
                            <label className="font-13 fw-bold" for="toa_do_x_ct">Tọa độ X</label>
                            <input type="text" className="form-control font-13" id="toa_do_x_ct" placeholder="Tọa độ X" />
                        </div>
                        <div className="form-group">
                            <label className="font-13 fw-bold" for="toa_do_y_ct">Tọa Độ Y</label>
        ...
        <div className="exploit-surfacewater mb-2">
            <p className="col-12 py-1 px-2 exploit-surfacewater-title fw-bold mb-2">Hạng mục công trình</p>
            <div className="pb-2 mx-0 px-2">
            <table className="table table-bordered">
                <thead className="thead-light">
                        <tr className="text-center">
            ...
            <div className="modal fade" id="HangMucCongTrinh" tabindex="-1" aria-labelledby="HangMucCongTrinhLabel" aria-hidden="true">
                <div className="modal-dialog modal-dialog-centered">
                    ...
                    <div className="modal-body">
                        <div className="form-group">
                            <label className="font-13 fw-bold" for="ten_hang_muc_ct">Tên hạng mục</label>
                            <input type="text" className="form-control font-13" id="ten_hang_muc_ct" placeholder="Ký hiêu CT" />
                        </div>
                        <div className="form-group">
                            <label className="font-13 fw-bold" for="toa_do_x_hang_muc_ct">Tọa độ X</label>
                            <input type="text" className="form-control font-13" id="toa_do_x_hang_muc_ct" placeholder="Tọa độ X" />
                        </div>
                        <div className="form-group">
                            <label className="font-13 fw-bold" for="toa_do_y_hang_muc_ct">Tọa Độ Y</label>
                            <input type="text" className="form-control font-13" id="toa_do_y_hang_muc_ct" placeholder="Tọa Độ Y" />
                        </div>
                        <div className="form-group">
                            <label className="font-13 fw-bold" for="muc_dich_hang_muc_vt">Mục đích</label>
        ...
        <div className="exploit-surfacewater mb-2">
            <div className="py-2 mx-0">
                <div className="form-group col-sm-12">
                    <label for="my-select">Giám sát theo thông tư</label>
