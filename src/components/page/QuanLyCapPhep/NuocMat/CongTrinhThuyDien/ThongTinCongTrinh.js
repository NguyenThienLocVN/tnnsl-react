...
export default class QuanLyCapPhepNuocMatXemThongTinCongTrinh extends React.Component {
    ...
    render(){
        ...
        return(
			<div className="p-0">
                <Header headTitle="THỦY ĐIỆN | XEM THÔNG TIN CONG TRINH" previousLink="/" showHeadImage={false} />
                    ...
                    <div className="col-lg-12 px-0 row mx-0">
                        ...
                        <div className="col-lg-2">
                            <nav className="nav flex-column nav-pills">
                                <Link to="/quan-ly-cap-phep/nuoc-mat/thuy-dien/xem-thong-tin-chung" className="nav-link ">Thông tin chung</Link>
                                <Link to="/quan-ly-cap-phep/nuoc-mat/thuy-dien/xem-thong-tin-cong-trinh" className="nav-link active">Thông tin công trình</Link>
