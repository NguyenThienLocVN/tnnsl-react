...
export default class QuanLyCapPhepNuocMatXemThongTinThuyDien extends React.Component {
    ...
    render(){
        ...
        return(
			<div className="p-0">
                <Header headTitle="THỦY ĐIỆN | XEM THÔNG TIN CHUNG" previousLink="/quan-ly-cap-phep/nuoc-mat/thuy-dien" showHeadImage={true} />
                <main className="d-flex flex-column flex-lg-row">
                    <div className="col-lg-12 px-0 row mx-0">
                        <div className="col-lg-2">
                            <nav className="nav flex-column nav-pills pt-3">
                                <Link to="/quan-ly-cap-phep/nuoc-mat/thuy-dien/xem-thong-tin-chung" className="nav-link text-dark border-bottom active">Thông tin chung</Link>
