			...
			<div className="p-0">
                ...
                <main className="d-flex flex-column">
                    ...
                    <div className="col-12 px-0 menu-page d-flex flex-column flex-lg-row">
                        ...
                        {/* Block 2 */}
                        <div className="col-12 col-lg-3 pb-3 pb-lg-0 px-0 mb-lg-3 report-block-two">
                        ...
                        {/* Block 3 */}
                        <div className="col-12 col-lg-3 pb-3 px-0 pb-lg-0 px-lg-0 mb-lg-3 report-block-three">
                        ...
                        {/* Block 4 */}
                        <div className="col-12 col-lg-3 pb-3 pb-lg-0 px-0 mb-lg-3 report-block-four">
                            <div className="col-12 d-flex align-items-center report-item report-item-three py-3 py-lg-0">
                                <div className="col-8 p-0">
                            ...
                            <div className="col-12 d-flex flex-column align-items-center report-item report-item-four pt-4">
                                ...
                                <div className="col-9 p-0">
                                    <p className="text-danger font-weight-bold text-center">BÁO CÁO HOẠT ĐỘNG KHAI THÁC, SỬ DỤNG, <br/> XẢ THẢI</p>
                                </div>
                            </div>
                        </div>
                    </div>
